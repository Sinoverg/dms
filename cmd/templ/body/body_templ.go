...
func Body() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</header><main id=\"main\" class=\"container-fluid\"><h1 style=\"text-align: center;\">Select table</h1><div class=\"change-tables\"><table class=\"grid\"><tr><th>Users</th><th>Broadcast</th><th>Files</th><th>Broadcasts_files</th><th>Broadcasts_users</th></tr><tr><td><button onClick=\"ChangeTableName(&#39;Users&#39;)\" hx-get=\"/templ/tables/users\" hx-target=\"main\">Change</button></td><td><button onClick=\"ChangeTableName(&#39;Broadcasts&#39;)\" hx-get=\"/templ/tables/broadcasts\" hx-target=\"main\">Change</button></td><td><button onClick=\"ChangeTableName(&#39;Files&#39;)\" hx-get=\"/templ/tables/videofiles\" hx-target=\"main\">Change</button></td><td><button onClick=\"ChangeTableName(&#39;Broadcasts_files&#39;)\" hx-get=\"/templ/tables/broadcasts_files\" hx-target=\"main\">Change</button></td><td><button onClick=\"ChangeTableName(&#39;Broadcasts_users&#39;)\" hx-get=\"/templ/tables/broadcasts_users\" hx-target=\"main\">Change</button></td></tr></table></div></main><footer></footer></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
